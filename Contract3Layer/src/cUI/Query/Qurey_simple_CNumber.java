...
public class Qurey_simple_CNumber extends JDialog implements ActionListener{
	JLabel label1,label2;
	JTextField textField1,textField2;
	JButton button1,button2;
	JPanel panel1,panel2,panel3,panel4;
	JTable table;
	public Qurey_simple_CNumber(Frame fck,String ckm,Boolean msck){
		super(fck,ckm,msck);
		
		label1=new JLabel("请设置要查询的合同编号：");
	...
	public JTable deadlineAlarm(){
		table=new JTable();
		String sql="select * from Contract where CNumber=?";
